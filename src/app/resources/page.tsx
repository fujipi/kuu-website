...
export const metadata: Metadata = seoMetadata({
	...
	description:
		"生成AI利用規程テンプレート・エージェントガバナンスチェックリスト・EU AI Act対応資料など、実務ですぐ使える資料を無料提供。",
	path: "/resources/",
});
			...
			<main>
				<div className="page-content">
					...
					>
						...
						AI Act
						対応資料など、実務担当者がすぐに使える実務資料を無料で公開しています。お問い合わせ経由でテンプレート本体をお送りします。
					</p>
